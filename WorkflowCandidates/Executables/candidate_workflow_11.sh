...
# Run Vasp
calc_energy_job = project.create.job.Vasp(jobName, delete_existing_job=True)
...
echo "1. output is: $node-1649878109"echo "2. output is: $node-629884301"echo "3. output is: $node-1430981793"